...
Scenario: Basic networking between two instances (auto-start connections, no relay flag) with connection loss
  ...
  When  instance "NodeB" loses connection
  Then  the visible network of "NodeB" should consist of "NodeB"
  
  When  instances re-establish connection
  Then  the visible network of "NodeB" should consist of "NodeA, NodeB"
